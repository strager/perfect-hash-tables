...
constexpr std::uint32_t table_size = 8192UL;
constexpr std::size_t min_keyword_size = 2;
constexpr std::size_t max_keyword_size = 11;
constexpr std::uint32_t hash_seed = 2166136261UL;
...
token_type look_up_identifier(const char* identifier, std::size_t size) noexcept {
    ...
    std::uint32_t index = hash_to_index(h, table_size, sizeof(table_entry), hash_to_index_strategy::shiftless);
