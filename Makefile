...
build/test: $(gperf_sos) test.cpp token.h implementations.h implementations-generated.inc Makefile build
...
build/libtoken-gperf-$(flags)-generated.so: token-gperf-$(flags)-generated.cpp token.h Makefile build
